...
// 1. Custom WhatsApp Icon (Brand Logo)
...
// 2. Custom TikTok Icon (Brand Logo)
function TikTokIcon() {
    return (
        <svg
            viewBox="0 0 24 24"
    ...
    return (
        <div className="fixed right-6 top-1/2 transform -translate-y-1/2 z-40 flex flex-col gap-4">
            ...
            <a
                ...
                // Added 'text-white' so 'currentColor' fill works
            ...
            <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                // Added 'text-white' so the SVG shows up against the black background
