                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            {/* Email */}
                            <a href="mailto:training@ktacademy.my" className="flex items-center gap-4 p-6 bg-[#F0F8FA] rounded-2xl border border-[#4297AA]/20 hover:shadow-lg transition-all">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600 break-all">training@ktacademy.my</p>
                                </div>
                            </a>

                            {/* Phone */}
                            <div className="flex items-start gap-4 p-6 bg-[#F0F8FA] rounded-2xl border border-[#4297AA]/20 hover:shadow-lg transition-all">
                                <div className="w-10 h-10 bg-[#D4AF37] rounded-full flex items-center justify-center flex-shrink-0">
                                    <Phone className="w-5 h-5 text-white" />
                                </div>
                                <div>
                                    <h3 className="font-bold text-[#0E6175] mb-1">Telefon</h3>
                                    <div className="flex flex-col gap-1 text-sm text-gray-600">
                                        <a href="tel:+60164263233" className="hover:text-[#0E6175] transition-colors">
                                            +60 16-426 3233 (Zaim)
                                        </a>
                                        <a href="tel:+60163233401" className="hover:text-[#0E6175] transition-colors">
                                            +60 16-323 3401 (Hanif)
                                        </a>
                                        <a href="tel:+60194090982" className="hover:text-[#0E6175] transition-colors">
                                            +60 19-409 0982 (Azman)
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex items-center justify-between p-6 rounded-2xl bg-[#1877F2] text-white hover:opacity-90 transition-all shadow-md group"
                            >
                                <div className="flex items-center gap-4">
